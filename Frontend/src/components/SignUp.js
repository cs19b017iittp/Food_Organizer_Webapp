...
import useForm from './loginPage/SignupForm';
import validate from './loginPage/validateInfo';
        ...
        <div className="form-container">
            ...
            <form className="form" onSubmit={handleSubmit} noValidate>
                ...
                <div className="form-inputs">
                    ...
                    <input id="phone" type="tel" name="phone" className="form-input" placeholder="Enter your phone number" value={values.phone} onChange={handleChange}/>
                ...
                <div className="form-inputs">
                    ...
                    <input id="password2" type="password" name="password2" className="form-input" placeholder="Re-enter your password" value={values.password2} onChange={handleChange}/>
                    {errors.password2 && <p>{errors.password2}</p>}
                </div>
                <button className="form-input-btn" type="submit">Sign up</button>
                <Link to="/loginpage" className="link-login">Already a user ?</Link>
            </form>
            </div>
        </div>
        </>
